...
type OrchestrationLogVariableChangeEventRepresentation struct {
	...
	NewValue *VariableRepresentation `json:"newValue"`

	OldValue *VariableRepresentation `json:"oldValue"`
}
